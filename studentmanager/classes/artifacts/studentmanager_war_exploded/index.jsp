...
<div >
    ...
    <div class="a">
        <h1 ><strong>实验六 面向对象软件案例的UML建模</strong></h1>

    </div>
    <div class="container">

        <a href="studentlist.jsp" class="nav-link">查看</a>
        <a href="studentupdate.jsp" class="nav-link">更新</a>
        <a href="studentinsert.jsp" class="nav-link">插入</a>
        <a href="studentshow.jsp" class="nav-link">删除</a>
